...
var hljs = function () {
        ...
        const E = "[a-zA-Z]\\w*", y = "[a-zA-Z_]\\w*", w = "\\b\\d+(\\.\\d+)?",
            N = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", v = "\\b(0b[01]+)", O = {
        ...
        const Ne = e => m(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), ve = ["Protocol", "Type"].map(Ne),
            Oe = ["init", "self"].map(Ne), ke = ["Any", "Self"],
            ...
            Le = p(Ie, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/), Be = m(Ie, Le, "*"),
            $e = m(/[A-Z]/, Le, "*"),
        ...
        ;var Ue = Object.freeze({
            ...
            grmr_c: e => {
                const n = e.regex, t = e.COMMENT("//", "$", {
                    ...
                    i = "(decltype\\(auto\\)|" + n.optional(a) + "[a-zA-Z_]\\w*" + n.optional("<[^<>]+>") + ")", r = {
                ...
                const n = e.regex, t = te(e), a = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE];
                return {
